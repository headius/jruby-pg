...
/**
 * select proname, pronargs, proargtypes from pg_catalog.pg_proc where proname like 'lo%';
 * proname      | pronargs      | proargtypes   | prorettype
 * -------------+---------------+-==------------+------------
 * lo_import    | 1             | 25            | 26
 * lo_import    | 2             | 25 26         | 26
 * lo_export    | 2             | 26 25         | 23
 * lo_open      | 2             | 26 23         | 23
 * lo_close     | 1             | 23            | 23
 * loread       | 2             | 23 23         | 17
 * lowrite      | 2             | 23 17         | 23
 * lo_lseek     | 3             | 23 23 23      | 23
 * lo_creat     | 1             | 23            | 26
 * lo_create    | 1             | 26            | 26
 * lo_tell      | 1             | 23            | 23
 * lo_truncate  | 2             | 23 23         | 23
 * lo_unlink    | 1             | 26            | 23
 *
 * ================================================================
 *
 * SELECT oid,typname from pg_catalog.pg_type where oid in (17, 23, 25, 26);
 * oid | typname
 * ----+---------
 * 17  | bytea
 * 23  | int4
